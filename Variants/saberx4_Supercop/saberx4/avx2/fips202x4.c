...
{
  __m256i s[25];
  unsigned char t0[SHA3_256_RATE];
  unsigned char t1[SHA3_256_RATE];
  unsigned char t2[SHA3_256_RATE];
  unsigned char t3[SHA3_256_RATE];
  unsigned int i;
  ...
  // absorb 4 message of identical length in parallel 
  keccak_absorb4x(s, SHA3_256_RATE, in0, in1, in2, in3, inlen, 0x06);


  // Squeeze output 
  keccak_squeezeblocks4x(t0, t1, t2, t3, 1, s, SHA3_256_RATE);
...
{
  __m256i s[25];
  unsigned char t0[SHA3_512_RATE];
  unsigned char t1[SHA3_512_RATE];
  unsigned char t2[SHA3_512_RATE];
  unsigned char t3[SHA3_512_RATE];
  unsigned int i;
  ...
  // absorb 4 message of identical length in parallel 
  keccak_absorb4x(s, SHA3_512_RATE, in0, in1, in2, in3, inlen, 0x06);


  // Squeeze output 
  keccak_squeezeblocks4x(t0, t1, t2, t3, 1, s, SHA3_512_RATE);
